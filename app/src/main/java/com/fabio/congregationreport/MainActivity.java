...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_home, R.id.nav_user, R.id.nav_group, R.id.nav_publishers)
    ...
    private void initComponents() {
        ...
        this.txtUser.setText(UtilDataMemory.userConectded.getName());
        this.txtEmail = (TextView) headerLayout.findViewById(R.id.txtEmail);
        this.txtEmail.setText("Usuário: " + UtilDataMemory.userConectded.getUserName()
                + " Tipo: " + UtilDataMemory.userConectded.getType());
    }
