package com.fabio.pdfcreator.activity;
...
import com.fabio.pdfcreator.R;
import com.fabio.pdfcreator.custom.ViewPagerForPhotoView;
...
public class PDFViewerActivity extends AppCompatActivity {
    ...
    public static class PdfPageFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater,
            ...
            ((AppCompatTextView) rootView.findViewById(R.id.textViewPdfViewerPageNumber))
                    .setText(String.format(Locale.getDefault(), "%d " + rootView.getResources().getString(R.string.label_of) + " %d", position + 1, pdfBitmapList.size()));
